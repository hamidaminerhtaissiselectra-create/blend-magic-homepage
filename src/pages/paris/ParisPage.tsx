...
const ParisPage = () => {
  ...
  // Services avec icônes colorées
  const services = [
    {
      icon: Camera,
      title: "Vidéosurveillance",
      description: "Caméras HD/4K, vision nocturne, accès mobile 24/7",
      link: "/services/videosurveillance",
      color: "from-blue-500 to-cyan-500",
      features: ["Caméras HD/4K", "Vision nocturne", "Cloud sécurisé"],
    },
    {
      icon: ShieldAlert,
      title: "Alarmes",
      description: "Systèmes certifiés NF&A2P, télésurveillance",
    ...
    },
    {
      ...
      description: "Badges RFID, biométrie, interphones vidéo",
    ...
    },
    {
      icon: Home,
      title: "Domotique",
      description: "Maison intelligente, automatisation sécurité",
    ...
    },
    {
      icon: Wifi,
      title: "Réseau",
      description: "Infrastructure WiFi 6E, câblage, firewall",
    ...
    },
    {
      icon: Wrench,
      title: "Maintenance",
      description: "Contrats annuels, dépannage 24/7",
